...
public class SubscriptionStepDef {
	...
	public void user_clicks_on_after_entering_the_required_medication_details(String string) {
	...
	public void sub_text_header_should_be_visible(String string) {
	    
	}

	@Then("There should be exactly {int} subscription plan tiles displayed")
	public void there_should_be_exactly_subscription_plan_tiles_displayed(Integer int1) {
	    
	}

	@Then("{string} section tile should be displayed inside Free plan tile")
	public void section_tile_should_be_displayed_inside_free_plan_tile(String string) {
	    
		
	}

	@Then("{string} section title should be displayed")
	public void section_title_should_be_displayed(String string) {
	    
	}

	@Then("{string} subtext under header should be visible")
	public void subtext_under_header_should_be_visible(String string) {
	...
	public void badge_text_should_be_displayed_on_monthly_plan_tile(String string) {
	    
	}

	@Then("{string} subheader should be displayed inside Monthly plan tile")
	public void subheader_should_be_displayed_inside_monthly_plan_tile(String string) {
	  
	}

	@Then("{string} subtext should be displayed")
	public void subtext_should_be_displayed(String string) {
	    
	}

	@Then("{string} badge text should be displayed on {int} Month Plan tile")
	public void badge_text_should_be_displayed_on_month_plan_tile(String string, Integer int1) {
	    
		
	}

	@Then("{string} subheader should be displayed")
	public void subheader_should_be_displayed(String string) {
	    
	}

	@Then("{string} text preceded with star symbol should be visible")
	public void text_preceded_with_star_symbol_should_be_visible(String string) {
	...
	public void user_clicks_on_after_finishing_all_onboarding_steps(String string) {
